...
import com.minejava.kafkastreams.authorizationserver.jose.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public SecurityFilterChain h2ConsoleSecutSecurityFilterChain(HttpSecurity http) throws Exception {
    ...
    public SecurityFilterChain oauth2SecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        RequestMatcher endpointsRequestMatcher = authorizationServerConfigurer.getEndpointsMatcher();
        ...
        http
            .securityMatcher(endpointsRequestMatcher)
            .authorizeHttpRequests((authorize) -> authorize
                    .anyRequest().authenticated()
            )
            .csrf(csrf -> csrf.ignoringRequestMatchers(endpointsRequestMatcher))
